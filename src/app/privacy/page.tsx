    ...
    <div className="flex min-h-0 flex-1 flex-col overflow-y-auto">
      <main className="mx-auto flex w-full max-w-2xl flex-col gap-[clamp(1.25rem,3vh,2rem)] px-6 py-[clamp(1rem,3vh,2rem)]">
        ...
        <Section title="データの保存期間・削除について">
          <p>
            現時点では、利用者自身がアカウントを削除する機能は提供していません。データの削除をご希望の場合は、下記の問い合わせ先よりID（あいでぃー）を添えてご連絡ください。確認のうえ対応します。
          </p>
        </Section>
        ...
        <Section title="お問い合わせ">
          <p>
            本ポリシーに関するご質問・データ削除のご希望は、GitHubリポジトリのIssueよりお願いします。Issueは公開の場のため、お子さまのお名前など個人情報を含む内容は書き込まないようお願いします。
          </p>
        </Section>
